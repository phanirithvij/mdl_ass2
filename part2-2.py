...
def recharge(h1, a1, s1, h2, a2, s2):
    ...
    # stamina not 100
        ...
        # since stamina increase therefore old-new = -50
        if check(h1, a1, s1, h2, a2, s2, 0, 0, -50):
            return 0.8
...
def vi():
    ...
    while(deltacheck > delta):
            ...
            for a1 in range(0, arrows):
                for s1 in range(0, stamina):
                        ...
                        for h2 in range(0, health):
                            for a2 in range(0, arrows):
                                for s2 in range(0, stamina):
                                    ...
                                    temp += round(round(callaction(ac, h1*25, a1, s1*50, h2*25, a2, s2*50), 3)*(
                                        reward+gamma*utilities[h2, a2, s2]), 11)
                    ...
                    if(abs(temparray[h1, a1, s1]-utilities[h1, a1, s1]) > deltacheck):
                        deltacheck = abs(
                            temparray[h1, a1, s1]-utilities[h1, a1, s1])
        ...
        for h1 in range(0, health):
            for a1 in range(0, arrows):
                for s1 in range(0, stamina):
                    print("("+str(h1)+","+str(a1)+","+str(s1)+"):" +
                          mapactions(actions[h1, a1, s1])+"=["+str(u[h1, a1, s1])+"]")
        print("\n")
